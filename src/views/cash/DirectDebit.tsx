...
const DirectDebit: React.FC = () => {
  ...
  return (
    <div className="flex justify-center">
      <Helmet>
        <title>Direct Debit - {import.meta.env.VITE_SITE_TITLE}</title>
      </Helmet>
      ...
      <div className="w-full flex flex-col">
        <h2 className="text-[#aeaeae] text-[1rem] font-[600] mb-2">Direct Debit</h2> 
           <div className="flex flex-col bg-gray-600 rounded-lg">
              <div className="flex justify-center mt-5 mb-10">
                  <div className="rounded-lg p-1 bg-white border-solid border-2 border-gray-400">   
                        <Link to="#">
                            <img className="w-14" src={BpiIcon} />
                        </Link>
                  </div> 
                  <div className="rounded-lg p-1 ml-2 bg-white border-solid border-2 border-gray-400">   
                        <Link to="#">
                            <img className="w-14" src={UbIcon} />
                        </Link>
                  </div> 
              </div>
